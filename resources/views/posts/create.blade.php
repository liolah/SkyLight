                    ...
                    <form action="{{ route('test') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 row">
                                <input  type="text" class="form-control @error('title') is-invalid @enderror ml-2" name="title"  required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <textarea class="form-control @error('body') is-invalid @enderror"  name="body" rows="7" required></textarea>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <input type="file" id="file" class="row @error('image') is-invalid @enderror" name="image">
                              @error('image')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
